...
import com.borges.cursomc.domain.ItemPedido;
...
import com.borges.cursomc.repositories.ItemPedidoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	@Autowired 
	ItemPedidoRepository itemPedidoRepositpry;
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat5= new Categoria(null, "Jaardinagem");
		Categoria cat6 = new Categoria(null, "Decoração");
		Categoria cat7 = new Categoria(null, "Perfumaria");
		Categoria cat8 = new Categoria(null, "Bricaolagem");
		...
		itemPedidoRepositpry.saveAll(Arrays.asList(ip1, ip2,ip3));
